...
const wallet = (state = INITIAL_STATE, action) => {
  ...
  case GET_CURRENCIES_SUCCESS: return { ...state,
    currencies: [...codes],
    isFetching: false };
  case GET_CURRENCIES_ERROR: return { ...state, error: action.error, isFetching: false };
  ...
  case REMOVE_EXPENSE: return { ...state,
    expenses: state.expenses.filter((expense) => expense.id !== action.id) };
  case SUM_EXPENSES: return { ...state, totalExpense };
